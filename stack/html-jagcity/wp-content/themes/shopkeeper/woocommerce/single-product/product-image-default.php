...
$featured_image_src					= wp_get_attachment_image_src( get_post_thumbnail_id(), 'shop_single' );
	        ...
	        <div class="swiper-wrapper">
	            ...
	            <div class="swiper-slide product-image">
			            ...
			            <div class="<?php echo $zoom_class; ?> woocommerce-product-gallery__image">
		                	...
		                	data-fresco-options="ui: 'outside', thumbnail: '<?php echo esc_url($featured_image_src[0]); ?>'" 
		                	...
		                	>			                    
								...
								<?php if ( has_post_thumbnail() ) { ?>
									<img src="<?php echo esc_url($featured_image_src[0]); ?>" data-src="<?php echo esc_url($featured_image_src[0]); ?>" class="wp-post-image">
		                        <?php } else { ?>
	            ...
	            if ( $attachment_ids ) {
	                ...
	                foreach ( $attachment_ids as $attachment_id ) {
						...
						$gallery_image_src    				= wp_get_attachment_image_src( $attachment_id, 'shop_single' );
	                    ...
	                    <div class="swiper-slide">
		                    ...
		                    <div class="<?php echo $zoom_class; ?>">
	                            ...
	                            data-fresco-group="product-gallery" 
	                            data-fresco-options="thumbnail: '<?php echo esc_url($gallery_image_src[0]); ?>'" 
	                            ...
	                            >
	                                ...
	                                <img src="<?php echo esc_url($gallery_image_src[0]); ?>" data-src="<?php echo esc_url($gallery_image_src[0]); ?>" alt="<?php echo esc_html($gallery_image_title); ?>">	                        
	                            </a>
