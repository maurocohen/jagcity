...
[/vc_column_text][vc_btn title="Ver Evento" color="chino" align="center"][/vc_column][vc_column width="1/4"][/vc_column][/vc_row][vc_row][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][vc_custom_heading text="Article Title" font_container="tag:h3|text_align:center" use_theme_fonts="yes"][vc_column_text]

Vivamus et risus in purus consequat interdum. Nam hendrerit euismod quam imperdiet maximus. Duis id eros eu lectus tempor interdum. Duis nec commodo enim. Proin lobortis sapien vitae eleifend tincidunt.

[/vc_column_text][vc_btn title="Ver Evento" color="chino" align="center"][/vc_column][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][vc_custom_heading text="Article Title" font_container="tag:h3|text_align:center" use_theme_fonts="yes"][vc_column_text]

Vivamus et risus in purus consequat interdum. Nam hendrerit euismod quam imperdiet maximus. Duis id eros eu lectus tempor interdum. Duis nec commodo enim. Proin lobortis sapien vitae eleifend tincidunt.

[/vc_column_text][vc_btn title="Ver Evento" color="chino" align="center"][/vc_column][/vc_row]
CONTENT;
...
This section is a perfect place to display introduction description for your products and services with an option to access more information by clicking "Ver Evento" button.

[/vc_column_text][vc_btn title="Ver Evento" style="outline" shape="square" color="white" align="left"][/vc_column][vc_column width="1/2"][vc_single_image img_size="medium" alignment="center" style="vc_box_rounded"][/vc_column][/vc_row][vc_row][vc_column width="1/3"][vc_custom_heading text="Heading with Theme Font" font_container="tag:h3|text_align:left" use_theme_fonts="yes" css=".vc_custom_1436530550784{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1436530603605{margin-bottom: 15px !important;}"]
