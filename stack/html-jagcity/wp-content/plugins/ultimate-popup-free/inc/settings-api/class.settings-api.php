 ...
 */
class WeDevs_Settings_API_Ultimate_Popup_Free {
    ...
    public static function getInstance() {
        if ( !self::$_instance ) {
            self::$_instance = new WeDevs_Settings_API_Ultimate_Popup_Free();
        }
        ...
        <div class="metabox-holder">
            <div class="postbox">
                <?php foreach ($this->settings_sections as $form) { ?>
                    <style>div.metabox-holder h3 {padding:0}</style>
                    <div style="padding:20px" id="<?php echo $form['id']; ?>" class="group">
