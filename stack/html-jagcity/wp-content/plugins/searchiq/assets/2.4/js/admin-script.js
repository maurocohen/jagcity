...
function syncPosts(a){
	...
	$jQu.ajax({
		...
		if(res.success == 0){
			...
			if(res.next != ""){
				...
				if(typeof res.thumbServiceDisabledMsg != "undefined" && typeof res.success != "undefined" && res.success){
					$jQu(".section.section-4").find(".data, h3, .message").remove();
					$jQu(".section.section-4").append(res.thumbServiceDisabledMsg);
				}
		...
		if(typeof jqXHR != "undefined" && typeof jqXHR.responseJSON != "undefined" && typeof jqXHR.responseJSON.message != "undefined" && jqXHR.responseJSON.message != ""){
